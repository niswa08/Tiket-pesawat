	...
	<div class="content">
		...
		<form action="insertpenumpang.php" method="POST" enctype="multipart/form-data">
			<div class="input-group">
				<input type="text" placeholder="Nomor Indentitas Customer" value="<?php while($rows=mysqli_fetch_array($hasil)){ $num = $rows['no_identitas']+$no; echo $num; }?>" name="no_identitas">
			</div>
			<div class="input-group">
				<input type="text" placeholder="Nama Customer" name="nama_konsumen">
			</div>
			<div class="input-group">
				<input type="text" placeholder="Alamat Customer" style="width: 300px;" name="almt_konsumen">
			</div>
			<div class="input-group">
				<input type="text" placeholder="Nomor Customer" name="telepon">
			</div>
			<div class="input-group">
