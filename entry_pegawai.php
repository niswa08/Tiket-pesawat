	...
	<div class="content">
		...
		<form action="insertpegawai.php" method="POST" enctype="multipart/form-data">
			<div class="input-group">
				<input type="text" placeholder="Nomor Indentitas Admin" value="<?php while($rows=mysqli_fetch_array($hasil)){ $num = $rows['no_pegawai']+$no; echo $num; }?>" name="no_pegawai">
			</div>
			<div class="input-group">
				<input type="text" placeholder="Nama Admin" name="nama_pegawai">
			</div>
			<div class="input-group">
				<input type="text" placeholder="Alamat Admin" style="width: 300px;" name="alamat_pegawai">
			</div>
			<div class="input-group">
